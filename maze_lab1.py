...
class Maze:
    ...
    def __init__(self, maze, weights=None, random_rewards=False):
        ...
        self.states_player, self.map         = self.__states();
        self.states_minotaur          = self.__states_minotaur();
        self.n_actions                = len(self.actions); #maybe need multiply human and minotaur ??
        self.n_states                 = len(self.states); # need varying ??
    ...
    def __move_player(self, state, action):
        ...
        row = self.states[state][0] + self.actions[action][0];  #state_player
